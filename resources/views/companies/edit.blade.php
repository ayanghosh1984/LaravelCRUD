...
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
<strong>Company Mobile Number:</strong>
<input type="number" name="mobile_number" class="form-control" placeholder="Company Mobile Number" value="{{ $company->mobile_number }}">
@error('mobile_number')
<div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
@enderror
</div>
